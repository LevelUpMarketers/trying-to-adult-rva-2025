...
transaction has not yet settled, the refund is stored and reattempted automatically by a cron job shortly after Authorize.Net's daily settlement (around 3:15&nbsp;AM) rather than voiding the entire transaction. The refund button becomes disabled with a tooltip to indicate the pending request. Leaving the **Refund $** field blank refunds the full amount paid for
