<?php
/**
 * Sample configuration for WordPress used by Trying To Adult.
 *
 * Copy this file to `wp-config.php` and fill in the values for your
 * environment. The resulting `wp-config.php` file is ignored by Git so
